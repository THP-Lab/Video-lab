...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/MzPSis7jY5)
...
```sh
npx nx serve video-lab
```

To create a production bundle:

```sh
npx nx build video-lab
```

To see all available targets to run for a project, run:

```sh
npx nx show project video-lab
```
